...
export class SensImprov {
  ...
  async sensGetConfig(){return (await this.rpc(CMD_SENS_GET_CONFIG,[],12000))[0]||"";}
  async sensSetConfig(encoded){return (await this.rpc(CMD_SENS_SET_CONFIG,[...new TextEncoder().encode(encoded)],15000))[0]||"";}
