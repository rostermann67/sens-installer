...
V2.8.6 — IDENTIDADE RÁPIDA
- Firmware Rev.13 inalterado.
- Nome e Serial não usam mais 3 ciclos longos.
- Fluxo por campo:
  SET uma vez -> se confirmou, segue;
  se falhou, 1 GET de recuperação;
  se ainda não bateu, 1 segunda tentativa de SET;
  1 GET final e encerra.
- Remove esperas superiores a 1 minuto na etapa de identidade.
- Runtime/Avançado/Genéricos/Correções permanecem com a lógica seletiva já validada.
