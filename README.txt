...
V2.6.6 — ROBUSTEZ
- Sem novos recursos; endurece somente as etapas ja validadas.
- Nome e Serial: ate 3 tentativas automaticas, leitura de volta e ressincronizacao Improv.
- Wi-Fi: ate 3 tentativas automaticas com espera e ressincronizacao entre falhas.
- Scan automatico da V2.6.5 preservado.
- SSID manual preservado.
- Firmware Rev.11 e todos os BIN permanecem IDENTICOS.
