SENS INSTALLER V2.9.2 — IDENTIDADE ATÔMICA
...
V2.9.2: correção metrológica com APLICAR CORREÇÃO no início, equação visível e gravação avançada otimizada pelo retorno direto do firmware, com leitura apenas como recuperação.
